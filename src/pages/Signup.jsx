  ...
  return (
    <div className="w-auto h-auto  block relative">
      ...
      <div className="absolute top-20 left-[450px] w-[350px] h-[500px] rounded-md flex flex-col p-[20px] bg-black/80 opacity-100 m-auto  items-center">
          <h1 className="text-white text-[30px] font-bold mr-[128px]  mb-4 mt-5">Sign Up</h1>
          ...
          <div className="flex flex-row items-center ">
            <h1 className="text-gray-500 text-[13px] font-bold">Already subscribed to Netflix?</h1>
          <Link to='/login'>  <h2 className="text-white font-bold  pl-3">Sign in</h2>
          </Link>
          </div>
        </div>
    </div>
